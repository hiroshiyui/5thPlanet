...
| 5–6 | VDP1 draw-slowdown hypothesis: `Write_/Read_CheckDrawSlowdown` ported (`9934411`) but proven a no-op for the BGM (our modelled draw duration is ~100× too short to overlap) | ✅ investigated, superseded by #8 |
