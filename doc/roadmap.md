...
renderer hoists + scanline-band composite + emu-thread decoupling), the fight-floor
rotation geometry (`5ee3ecb`/`ac712a8`), and the **missing in-fight SFX**
(`7dfbfab`, SCSP B-bus wait-states — see the Phase 4 row). Pursued purely on the **real-BIOS LLE path**,
