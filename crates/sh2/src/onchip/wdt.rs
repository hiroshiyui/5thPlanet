//! SH7604 WDT module — register storage only for M1.
//!
//! Real WDT behaviour is not required by the SH-2 core itself; future
...
/// Generic 16-byte register bank covering the WDT address span.
