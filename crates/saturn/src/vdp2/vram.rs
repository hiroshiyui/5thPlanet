//! VDP2 VRAM — 512 KiB at `0x05E0_0000..=0x05E7_FFFF`.
//!
//! Hardware splits VRAM into four 128 KiB banks (A0, A1, B0, B1) for
//! parallel cycle-pattern access; the renderer's bank-allocation
//! awareness is a later refinement. M3 treats VRAM as one flat
//! 512 KiB region; addressing folds modulo size so accesses past the
//! end mirror back to the start.
